...
/** Chrome-colour partner to <BottomBar/>, shown only on Setup and Score —
 *  the two screens without their own full-bleed themed background. `sticky`
 *  (not `fixed`) so it reserves its own space in flow instead of needing
 *  matching padding-top, but stays pinned once content scrolls past it.
 *
